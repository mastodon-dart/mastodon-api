...
Go to the [pull request page of mastodon_api][prs] and in the top
...
- fix: Avoid execute something in `MastodonAPi`
- docs: Add a example
- docs: Improve the README
- test: Add test for `user_data.dart`
- refactor: Optimize the structure of `MastodonClient`
